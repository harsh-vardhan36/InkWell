...
public class EmailService {
    ...
    public String buildLoginAlertHtml(String fullName) {
        return "<!DOCTYPE html>" +
            "<html lang='en'><head><meta charset='UTF-8'>" +
            "<meta name='viewport' content='width=device-width, initial-scale=1.0'>" +
            "<title>New Login Detected</title></head>" +
            "<body style='margin:0;padding:0;background-color:#0f0f1a;font-family:\"Segoe UI\",Arial,sans-serif;'>" +
            "<table width='100%' cellpadding='0' cellspacing='0' style='background-color:#0f0f1a;padding:40px 20px;'>" +
            "  <tr><td align='center'>" +
            "    <table width='600' cellpadding='0' cellspacing='0' style='background:linear-gradient(145deg,#1a1a2e,#16213e);border-radius:16px;overflow:hidden;border:1px solid rgba(139,92,246,0.3);'>" +
            "      <tr><td style='background:linear-gradient(135deg,#6d28d9,#4f46e5);padding:40px 48px;text-align:center;'>" +
            "        <div style='font-size:32px;font-weight:800;color:#ffffff;letter-spacing:-1px;'>✍️ InkWell</div>" +
            "        <div style='color:rgba(255,255,255,0.75);font-size:14px;margin-top:6px;letter-spacing:2px;text-transform:uppercase;'>Security Alert</div>" +
            "      </td></tr>" +
            "      <tr><td style='padding:48px;'>" +
            "        <h1 style='color:#e2e8f0;font-size:24px;font-weight:700;margin:0 0 12px;'>New Login Detected 🔔</h1>" +
            "        <p style='color:#94a3b8;font-size:16px;line-height:1.6;margin:0 0 32px;'>Hi <strong style='color:#c4b5fd;'>" + fullName + "</strong>, we noticed a new login to your InkWell account.</p>" +
            "        <div style='background:rgba(109,40,217,0.1);border-left:4px solid #6d28d9;padding:24px;margin:0 0 32px;'>" +
            "          <p style='color:#94a3b8;font-size:14px;margin:0;'>If this was you, you can safely ignore this email. If not, please secure your account immediately.</p>" +
            "        </div>" +
            "        <a href='#' style='display:inline-block;background:#6d28d9;color:#ffffff;padding:14px 28px;border-radius:8px;text-decoration:none;font-weight:700;font-size:14px;'>Secure Account</a>" +
            "      </td></tr>" +
            "    </table>" +
            "  </td></tr>" +
            "</table>" +
